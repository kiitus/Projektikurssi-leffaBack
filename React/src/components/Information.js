...
const Information = ({movies}) => {   //Component for information about the site
    
    const numberOfReviews = movies.reduce((total,current)=>
{
   return total += current.reviews.length
},0 )
    ...
    return (
        <div style={margin}>
            ...
            <p>There are {movies.length} movies reviewed in the site and the total amount of reviews is {numberOfReviews}</p>
            <p>
